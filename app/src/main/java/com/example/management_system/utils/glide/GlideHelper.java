package com.example.management_system.utils.glide;
...
import com.example.management_system.utils.glide.progress.OnProgressListener;
import com.example.management_system.utils.glide.progress.ProgressInterceptor;
import com.example.management_system.utils.listener.SimpleCallback;
import com.example.management_system.utils.listener.SimpleListener;
...
public class GlideHelper {
    ...
    private RequestBuilder<File> mBuilderFile;
    ...
    public GlideHelper load(String url) {
        ...
        switch (as) {
            ...
            case BITMAP:
                ...
                break;
            case FILE:
                mBuilderFile = getFileBuilder().load(url);
                break;
            default:
        }
        return this;
    ...
    public GlideHelper load(Uri uri) {
        switch (as) {
            ...
            case BITMAP:
                ...
                break;
            case FILE:
                mBuilderFile = getFileBuilder().load(uri);
                break;
            default:
        }
        return this;
    ...
    public GlideHelper load(int resId) {
        switch (as) {
            ...
            case BITMAP:
                ...
                break;
            case FILE:
                mBuilderFile = getFileBuilder().load(resId);
                break;
            default:
        }
        return this;
    ...
    public GlideHelper load(File file) {
        switch (as) {
            case DRAWABLE:
                mBuilder = getBuilder().load(file);
                break;
            case GIF:
                mBuilderGif = getGifBuilder().load(file);
                break;
            case BITMAP:
                mBuilderBmp = getBmpBuilder().load(file);
                break;
            case FILE:
                mBuilderFile = getFileBuilder().load(file);
                break;
            default:
        }
        return this;
    ...
    private RequestBuilder<File> getFileBuilder() {
        if (mBuilderFile == null) {
            mBuilderFile = mManager.asFile();
        }
        return mBuilderFile;
    }
